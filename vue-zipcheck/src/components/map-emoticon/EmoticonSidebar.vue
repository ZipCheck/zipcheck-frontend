<template>
  <aside class="absolute top-4 left-4 bottom-4 z-20 w-80 flex flex-col gap-4 pointer-events-none">
    <div
    ...
    >
      <div class="flex items-center gap-2 mb-4">
        <div class="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 p-1.5 rounded-lg">
          <span class="material-symbols-outlined text-base">emoji_emotions</span>
        </div>
        <h2 class="font-bold text-gray-800 dark:text-white text-sm">이모티콘 리뷰 등록 가이드</h2>
      </div>
      <div class="space-y-6 relative">
        <div class="absolute left-[11px] top-2 bottom-4 w-0.5 bg-gray-100 dark:bg-gray-700 -z-10"></div>
        <div class="flex gap-3">
          ...
          <div>
            <p class="text-xs font-bold text-gray-900 dark:text-gray-100">위치 인증</p>
            <p class="text-[11px] text-gray-500 mt-1 leading-snug">
              GPS를 통해 현재 위치를 인증합니다. 실제 거주자만 리뷰를 남길 수 있습니다.
            </p>
            <button
            ...
            >
              <span class="material-symbols-outlined text-xs">my_location</span> 내 위치 인증하기
            </button>
          </div>
        </div>
        <div class="flex gap-3">
          ...
          <div>
            <p class="text-xs font-bold text-gray-900 dark:text-gray-100">감정 표현 선택</p>
            <p class="text-[11px] text-gray-500 mt-1 leading-snug">
        ...
        <div class="flex gap-3">
          ...
          <div>
            <p class="text-xs font-bold text-gray-900 dark:text-gray-100">한줄 평 작성</p>
            <p class="text-[11px] text-gray-500 mt-1 leading-snug">
      ...
      <div class="mt-auto pt-6">
        ...
        >
          <span class="text-xs text-gray-400 block mb-1">이번 달 등록된 리뷰</span>
