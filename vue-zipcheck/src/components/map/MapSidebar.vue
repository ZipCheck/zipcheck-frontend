<template>
  ...
  >
    ...
    <div class="px-5 py-3 border-b border-gray-100 dark:border-gray-800 flex gap-2 overflow-x-auto no-scrollbar">
      <button
    ...
    <div class="flex-grow overflow-y-auto p-4 space-y-4 bg-background-light dark:bg-background-dark">
...
const properties = ref([
  {
    ...
    size: '110m²',
    tags: [
      { text: '교통 편리', type: 'positive', icon: 'sentiment_satisfied' },
      { text: '소음 보통', type: 'neutral', icon: 'sentiment_neutral' },
    ],
  },
  {
    id: 2,
    ...
    price: '12억',
    size: '84m²',
    tags: [{ text: '학군 우수', type: 'positive', icon: 'school' }],
  },
  {
    id: 3,
    type: '매매',
    name: '잠실 리센츠',
    address: '서울 송파구 올림픽로 135',
    price: '24억 1,000',
    size: '109m²',
    tags: [{ text: '주차 부족', type: 'negative', icon: 'sentiment_dissatisfied' }],
  },
]);
</script>
