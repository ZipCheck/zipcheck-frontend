<template>
  ...
  >
    <div class="flex flex-col md:flex-row justify-between items-start gap-4 mb-6 border-b border-gray-100 dark:border-gray-700 pb-6">
      <div>
        <div class="flex items-center gap-2 mb-2">
          <span class="bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 text-xs font-bold px-2 py-1 rounded"
            >매매</span
          >
          <span class="text-text-sub-light dark:text-text-sub-dark text-sm">등록일 2023.10.27</span>
        </div>
        <h1 class="text-3xl font-bold mb-2">래미안 원베일리 108동</h1>
        <p class="text-text-sub-light dark:text-text-sub-dark flex items-center gap-1">
          <span class="material-symbols-outlined text-sm">location_on</span>
          서울시 서초구 반포동
        </p>
      </div>
      <div class="text-right md:text-right w-full md:w-auto">
        <p class="text-sm text-text-sub-light dark:text-text-sub-dark mb-1">매매가</p>
        <p class="text-4xl font-bold text-primary dark:text-yellow-400">38억 5,000</p>
        <p class="text-sm text-text-sub-light dark:text-text-sub-dark mt-1">(평당 1.1억)</p>
      </div>
    </div>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
      <div class="flex flex-col">
        <span class="text-xs text-text-sub-light dark:text-text-sub-dark font-medium uppercase tracking-wider mb-1"
          >공급/전용면적</span
        >
