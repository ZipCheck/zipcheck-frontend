	...
	<div class="flex-grow flex items-center justify-center p-4 sm:p-8">
		...
		>
			...
			<form @submit.prevent="handleLogin" class="space-y-5" method="POST">
				...
				<button
					:disabled="loading"
					class="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-sm text-base font-bold text-white bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all transform active:scale-[0.98] disabled:opacity-50"
					type="submit"
				>
