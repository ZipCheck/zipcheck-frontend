		...
		<div v-if="board">
			...
			>
				<ol class="inline-flex items-center space-x-1 md:space-x-3">
					<li class="inline-flex items-center">
						<router-link
							to="/"
							class="inline-flex items-center hover:text-primary"
						>
					...
					<li>
						<div class="flex items-center">
							<span class="material-symbols-outlined text-base mx-1"
								>chevron_right</span
							>
							<router-link to="/boards" class="hover:text-primary">{{
					...
					<li aria-current="page">
						<div class="flex items-center">
							...
							>
							<span
								class="font-medium text-text-main-light dark:text-text-main-dark truncate w-64"
								>{{ board.title }}</span
							>
						</div>
					</li>
			...
			<div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
				<div class="lg:col-span-8 space-y-8">
					...
					>
						<header
							class="mb-6 border-b border-gray-100 dark:border-gray-700 pb-6"
						>
							...
							<div class="flex items-center justify-between">
								<div class="flex items-center gap-3">
									...
									>
										<img
											v-if="board.writerAvatar"
											:src="board.writerAvatar"
											alt="Writer Avatar"
											class="w-full h-full object-cover"
										/>
										<span
											v-else
											class="material-symbols-outlined text-gray-400 dark:text-gray-300"
											>person</span
										>
									</div>
									<div>
					...
					>
						...
						<div class="space-y-6">
							...
							>
								...
								>
									<img
										v-if="comment.writerAvatar"
										:src="comment.writerAvatar"
							...
							<div
								...
								class="w-full h-px bg-gray-100 dark:bg-gray-700"
							></div>
						</div>
						<button
							v-if="board.comments && board.comments.length > 5"
				...
				<aside class="lg:col-span-4 space-y-8">
					...
					>
						<div class="flex flex-col items-center text-center">
							...
							<p
								class="text-sm text-text-sub-light dark:text-text-sub-dark mb-4"
							>
								가입일: {{ board.writerJoinDate || '2023.01.15' }}
							</p>
							<div class="w-full grid grid-cols-2 gap-2 mb-4">
								<div
									class="bg-gray-50 dark:bg-gray-800 p-3 rounded-xl text-center"
								>
									<div
										class="text-xs text-text-sub-light dark:text-text-sub-dark mb-1"
									>
										작성글
									</div>
