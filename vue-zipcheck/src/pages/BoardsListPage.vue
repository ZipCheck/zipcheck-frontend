        ...
        <div class="flex-1">
          <div class="flex flex-wrap justify-between items-center mb-6 gap-4">
            <div class="text-sm text-text-sub-light dark:text-text-sub-dark">
              총 <span class="font-bold text-gray-900 dark:text-white">{{ boards.length }}</span>개의 글이
              있습니다.
            </div>
          ...
          <div class="space-y-4">
            <router-link v-for="board in boards" :key="board.boardId" :to="`/boards/${board.boardId}`">
              <article
                  ...
                  <div class="flex-1">
                    <div class="flex items-center gap-2 mb-2">
                      ...
                      <span class="text-xs text-text-sub-light dark:text-text-sub-dark"
                        >{{ new Date(board.createdAt).toLocaleDateString() }}</span
                      >
                    </div>
                    <h2
                      ...
                      <div class="flex items-center gap-3">
                        <div class="flex items-center gap-2">
                          <img
                            ...
                            :src="board.writerAvatar || 'https://lh3.googleusercontent.com/a/ACg8ocK_3_4c-B4o-2T_nS5sL_2n3-jBC_0iL_w'"
                          />
